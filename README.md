...
- **Huawei SUN2000** (via [Huawei Solar](https://github.com/wlcrs/huawei_solar) Integration) — Single oder Master/Slave (mehrere Wechselrichter + Batterien). Nur bei **direkter** Anbindung an den Wechselrichter/Dongle; **Huawei über EMMA wird nicht unterstützt** (keine Batteriesteuerung möglich, siehe [Huawei-Guide](docs/guides/huawei.md)).

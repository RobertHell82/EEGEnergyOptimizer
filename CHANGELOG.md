...
- **Netzbezug-Watchdog schützt jetzt alle Wechselrichter — mit 15-Minuten-Pause statt Tagesabbruch.** Bisher lief der Watchdog nur bei SolarEdge. Netzbezug während der Nacht-Entladung kann aber bei jedem Wechselrichter auftreten: Die Entladeleistung ist fix (Standard 5 kW), und liegt der Hausverbrauch darüber, wird die Differenz aus dem Netz gekauft, statt für die EEG einzuspeisen. Neu wird der Watchdog bei allen Typen ausgewertet (Netzbezug > 1 kW für > 5 zusammenhängende Minuten): **SolarEdge** bricht weiterhin für den Rest des Tages ab, **Huawei/Fronius/SolaX** pausieren nur 15 Minuten und bewerten danach neu — dort ist die Ursache typischerweise eine vorübergehende Lastspitze (E-Auto, Wärmepumpe). Aktivitätsprotokoll und Panel weisen Pause und Abbruch getrennt aus.

### Dokumentation

- Die Inbetriebnahme-Anleitung weist jetzt auf die Einlaufzeit hin: Der Optimizer braucht etwa eine Woche Dauerbetrieb, bis für jeden Wochentag ein eigenes Verbrauchsprofil vorliegt.

## [1.3.4-dev] - 2026-08-09

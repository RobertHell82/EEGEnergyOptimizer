      ...
      <div class="dashboard-grid${narrowClass}">
        ...
        <div class="card header-card">
          <h3 class="status-card-title" style="margin-top:0;display:flex;align-items:center;gap:8px">
            ...
            Aktueller Status
            <ha-icon icon="mdi:information-outline" style="--mdc-icon-size:16px;color:var(--secondary-text-color);cursor:help;margin-left:auto"
              title="Register-Schreibvorg\u00e4nge (NVRAM): ${this._readFloat("sensor.eeg_energy_optimizer_register_schreibvorgaenge") ?? 0} seit Installation"></ha-icon>
          </h3>
